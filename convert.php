...
<html>
	<head>
		<title>SpartanNash Proof Express | Conversion</title>
	...
	<body>
		...
		<div class="row">
			...
			<div class="col-sm-8">
				<div class="well">
					<p style="text-align:left">This application will take you through the steps to update the Proof Express Database.</p>
				</div>
			</div>
				...
				<div class="well">
					<div class="row">
						<div class="col-sm-6">
							...
							<p style="text-align:left">This step will collect notation data from existing tables and import it into the newly-created "comments" column in the "projects" table.</p>
							<p style="text-align:left">Progress will be displayed in the window to the right.</p>
							<button id="btn1" type="button" class="btn btn-info" onclick="start_task('ajax/projectcomments.php','btn1','step1','log1','prog1')">Update Project Comments</button>
						</div>
						<div class="col-sm-6">
							<div class="progress">
								<div id="prog1" class="progress-bar progress-bar-striped active" role="progressbar" style="width:0%"></div>
							</div>
							<div id="log1" style="max-height:200px;text-align:left;overflow:scroll;background-color:#fff;height:auto;"></div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="well">
					<div class="row">
						<div class="col-sm-6">
							...
							<p style="text-align:left">This step will collect notation data from existing tables and import it into the newly-created "comments", "pages" and "approval" columns in the "ads" table.</p>
							<p style="text-align:left">Progress will be displayed in the window to the right.</p>
							<button id="btn2" type="button" class="btn btn-info" onclick="start_task('ajax/adcomments.php','btn2','step2','log2','prog2')">Update Ad Data</button>
						</div>
						<div class="col-sm-6">
							<div class="progress">
								<div id="prog2" class="progress-bar progress-bar-striped active" role="progressbar" style="width:0%"></div>
							</div>
							<div id="log2" style="max-height:200px;text-align:left;overflow:scroll;background-color:#fff;"></div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="well">
					<div class="row">
						<div class="col-sm-6">
							...
							<p style="text-align:left">This step will update page data in the database, and move image files from the  "projects" folder into the newly-created and simplified "proofs" folder.</p>
							<p style="text-align:left">Progress will be displayed in the window to the right.</p>
							<button id="btn3" type="button" class="btn btn-info" onclick="start_task('ajax/convertdb.php','btn3','step3','log3','prog3')">Convert DB</button>
...
<!--						<button id="txtlog3" type="button" class="btn btn-default" onclick="textLog('log3')">Export Log</button> -->
							<button id="stop" type="button" class="btn btn-danger" onclick="stop_task('prog3')">Cancel</button>
						</div>
						<div class="col-sm-6">
							<div id="eta" style="background-color:#fff;"></div>
							<div class="progress">
								<div id="prog3" class="progress-bar progress-bar-striped active" role="progressbar" style="width:0%"></div>
							</div>
							<div id="log3" style="max-height:200px;text-align:left;overflow:scroll;background-color:#fff;"></div>
						</div>
					</div>
				</div>
			</div>
		...
		<script>
			$('#downloadLink').click(function(){
				downloadInnerHtml(fileName, 'log3','text/html');
			});
		</script>
	</body>
</html>