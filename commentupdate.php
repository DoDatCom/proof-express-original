...
<html>
    <head>
		<title>SpartanNash Proof Express | Comments Update</title>
	...
	<body>
		<h3>Proof Express Comments Update</h3>
		<div class="row">
			<div class="col-sm-2">
			...
			<div class="col-sm-8">
				<div class="well">
					<p style="text-align:left">This application will update comment totals, so that only the comment count for current versions will be displayed.</p>
				</div>
			</div>
				...
				<div class="well">
					<div class="row">
						<div class="col-sm-6">
							...
							<p style="text-align:left">This step will update the status of ads within archive folders.</p>
							<p style="text-align:left">Progress will be displayed in the window to the right.</p>
							<button id="btn3" type="button" class="btn btn-info" onclick="start_task('ajax/setstatus.php','btn3','step3','log3','prog3')">Set Status</button>
				...
				<div class="well">
					<div class="row">
						<div class="col-sm-6">
							...
							<p style="text-align:left">This step will update comment counts within each ad.</p>
							<p style="text-align:left">Progress will be displayed in the window to the right.</p>
							<button id="btn1" type="button" class="btn btn-info" onclick="start_task('ajax/adcomments.php','btn1','step1','log1','prog1')">Update Ad Comments</button>
                            <button id="txtlog1" type="button" class="btn btn-default" onclick="textLog('log1')">Export Log</button>
						</div>
						<div class="col-sm-6">
							<div class="progress">
				...
				<div class="well">
					<div class="row">
						<div class="col-sm-6">
							...
							<p style="text-align:left">This step will update comment counts within each project.</p>
							<p style="text-align:left">Progress will be displayed in the window to the right.</p>
							<button id="btn2" type="button" class="btn btn-info" onclick="start_task('ajax/projectcomments.php','btn2','step2','log2','prog2')">Update Project Comments</button>
                            <button id="txtlog2" type="button" class="btn btn-default" onclick="textLog('log2')">Export Log</button>
						</div>
						<div class="col-sm-6">
							<div class="progress">
