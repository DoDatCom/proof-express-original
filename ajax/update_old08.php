...
//	Initialize directory variables.
	...
	while($pg=mysqli_fetch_assoc($newPage)){
		...
		if($pg["hrtype"]=='pdf'){
			...
			exec('chmod -R 0775 "'.$dir.'PDF/'.$pgID.'.pdf"');
			...
			$gs=exec_timeout(GS_PATH.'gs -dBATCH -dNOPAUSE -r72 -sDEVICE=jpeg -dTextAlphaBits=4 -dGraphicsAlphaBits=4 -dJPEGQ=80 -g'.$dimScale.' -dPDFFitPage -sOutputFile="'.$dir.'IMG/'.$pgID.'.jpg" "'.$dir.'PDF/'.$pgID.'.pdf" 2>&1',60);
			if($gs!=='GS_OK'){
