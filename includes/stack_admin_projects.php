	...
	<div class="panel panel-default">
		...
		<div id="collapse6" class="panel-collapse collapse">
			<div class="panel-body">
				<ul class="list-group">
					<li class="list-group-item"><a href="#">Administer Notifications</a></li>
<?php echo '		<li class="list-group-item"><a href="projectsecurity.php?p='.$id.'">Edit Project Security</a></li>'; ?>
